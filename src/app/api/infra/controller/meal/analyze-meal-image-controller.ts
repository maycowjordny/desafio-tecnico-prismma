import { AnalyzeMealImageUseCase } from "@/app/api/application/use-cases/meal/analyze-meal-image-use-case";
import { ensureAuthenticated } from "@/utils/get-session-user-id";
import { responseHandler } from "@/utils/response-handler";
import { NextRequest } from "next/server";

export class MealImageAnalysisController {
  async analyze(request: NextRequest) {
    try {
